...
LEGACY_SPEED_PRESETS: dict[str, dict[str, list[float]]] = {
    "very_slow": {
        "russian": [0.45, 0.5, 0.55, 0.6, 0.65, 0.7],
        "english": [0.4, 0.45, 0.5, 0.55, 0.6, 0.65],
    },
    "slow": {
        "russian": [0.65, 0.72, 0.78, 0.84, 0.9, 0.95],
        "english": [0.6, 0.68, 0.74, 0.8, 0.86, 0.9],
    },
    "normal": {
        "russian": [0.9, 0.95, 1.0, 1.0, 1.0, 1.0],
        "english": [0.85, 0.9, 0.95, 1.0, 1.0, 1.0],
    },
    "fast": {
        "russian": [1.1, 1.15, 1.2, 1.28, 1.35, 1.42],
        "english": [1.05, 1.1, 1.18, 1.24, 1.3, 1.36],
    },
    "very_fast": {
        "russian": [1.3, 1.38, 1.45, 1.55, 1.65, 1.75],
        "english": [1.25, 1.32, 1.4, 1.5, 1.58, 1.68],
    },
}
