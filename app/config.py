...
class Settings(BaseSettings):
    ...
    alt_model_name: str = Field("F5TTS_v1_Base", alias="F5_TTS_ALT_MODEL_NAME")
    alt_checkpoint_file: str = Field("", alias="F5_TTS_ALT_CHECKPOINT_FILE")
    alt_vocab_file: str = Field("", alias="F5_TTS_ALT_VOCAB_FILE")
    alt_model_label: str = Field("EN-capable F5", alias="F5_TTS_ALT_MODEL_LABEL")
    alt_model_repo_id: str = Field("", alias="F5_TTS_ALT_MODEL_REPO_ID")
